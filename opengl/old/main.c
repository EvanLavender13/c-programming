...
winloop(GLFWwindow *w)
{
    ...
    // createuniform(sprog, "color");
    // createuniform(sprog, "usecolor");
    ...
    while (!glfwWindowShouldClose(w)) {
        ...
        //     // TODO: make wrapper functions for uniforms?
        //     glUniform3f(sprog->ucol, t->model->mesh->color[0], t->model->mesh->color[1], t->model->mesh->color[2]);
        //     glUniform1i(sprog->uucol, t->model->mesh->texid == 0);
            
        //     // activate texture
        //     if (t->model->mesh->texid > 0) {
        //         glActiveTexture(GL_TEXTURE0);
        //         glBindTexture(GL_TEXTURE_2D, t->model->mesh->texid);
        //     }
